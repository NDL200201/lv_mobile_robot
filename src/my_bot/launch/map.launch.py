...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/color/image_raw',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/aligned_depth_to_color/image_raw', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/color/camera_info',            description=''),
        ...
        # Odometry
        DeclareLaunchArgument('visual_odometry',            default_value='flase',  description='Launch rtabmap visual odometry node.'),
